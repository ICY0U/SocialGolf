...
protected:
    ...
    // Dart input functions - NEW
    void DropDartPressed();
    void SpawnDartPressed();
    void SpawnDartboardPressed();

    // Dart system functions - NEW
    void ThrowDart(float ThrowPower);
    void DropDart();
    void SpawnDart();
    void SpawnDartboard();
...
public:
    ...
    // Server RPCs for dart system - NEW
    UFUNCTION(Server, Reliable, BlueprintCallable, Category = "Dart")
    void ServerThrowDart(const FVector& ThrowDirection, float ThrowPower);
    ...
    void SetHeldDart(ASGDart* Dart);

    UFUNCTION(BlueprintCallable, Category = "Dart")
    ASGDart* GetHeldDart() const { return HeldDart; }

    UFUNCTION(BlueprintCallable, Category = "Dart")
    bool IsHoldingDart() const { return HeldDart != nullptr; }

    // Dart charging system - NEW
    UFUNCTION(BlueprintCallable, Category = "Dart")
    void StartChargingDart();

    UFUNCTION(BlueprintCallable, Category = "Dart")
    void ReleaseDart();

    // Dart system functions
    UFUNCTION(BlueprintCallable, Category = "Dart")
    void StartChargingDartShot();

    UFUNCTION(BlueprintCallable, Category = "Dart")
    void ReleaseDartShot();
...
protected:
    ...
    // Dart state - NEW
    UPROPERTY(ReplicatedUsing = OnRep_HeldDart, BlueprintReadOnly, Category = "State")
    ASGDart* HeldDart = nullptr;
    ...
    // Dart charging settings - NEW
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Dart Physics")
    float DartMinPower = 10.0f;   // Minimum power for dart throws

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Dart Physics")
    float DartMaxPower = 50.0f;   // Maximum power for dart throws
